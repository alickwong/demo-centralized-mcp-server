...
- Permissions for: Lambda, IAM, Bedrock AgentCore
...
├── terraform/                   # Lambda, IAM resources
│   ├── lambda.tf
│   ├── iam.tf
│   ├── variables.tf
│   ├── outputs.tf
...
| IAM roles | Lambda execution + Gateway roles |
...
- Run the **Cleanup** cell at the bottom of `01_setup.ipynb` to delete all AWS resources (Gateway, Lambda, IAM)
